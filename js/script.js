...
Extra 3: Responsive mobile design
Extra 4: Audio
...
function randomHole(){
    ...
    //loop through each of thehole and remove the mole. And create a variable for random placement of these moles with the holes in this function.
